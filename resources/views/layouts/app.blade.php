...
{{--                                <li><a href="{{route('index')}}" style="text-transform: capitalize" class="dropdown-item">all</a></li>--}}
{{--                                @foreach($categories as $category)--}}
{{--                                    <li><a class="dropdown-item" style="text-transform: capitalize" href="{{route('index')}}?category_id={{$category->id}}">{{$category->title}}</a></li>--}}
{{--                                @endforeach--}}
{{--                            </ul>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
